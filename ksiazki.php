...
$sql = "SELECT * FROM biblAutor_biblTytuł,biblTytuł,biblAutor where biblAutor.id_autorbibl=Autor_biblTytuł.biblAutor_id and biblAutor_biblTytuł.biblTytuł_id=biblTytuł.id_tytuł";
    $result = mysqli_query($conn, $sql);
        echo('<table border="1">');
